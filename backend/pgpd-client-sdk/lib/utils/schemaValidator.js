...
const validatePaycollectPayload = (payload) => {
  ...
  if (!valid) {
    ...
    //  console.error('Validation errors:', problematicFields);
...
// Alias for PayDirect validation (same schema as PayCollect)
const validatePayDirectPayload = validatePaycollectPayload;

module.exports = {
  validatePaycollectPayload,
  validatePayDirectPayload,
