...
class PayDirectJWTAPIReferenceScreen extends StatefulWidget {
  const PayDirectJWTAPIReferenceScreen({super.key});

  @override
  _PayDirectJWTAPIReferenceScreenState createState() => _PayDirectJWTAPIReferenceScreenState();
}

class _PayDirectJWTAPIReferenceScreenState extends State<PayDirectJWTAPIReferenceScreen> with TickerProviderStateMixin {
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ...
            if (AppNavigation.canPop()) {
              ...
              AppNavigation.to(AppRouter.paydirectJwtDetail);
            }
          },
      ...
      constraints: const BoxConstraints(maxWidth: 900),
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
            ...
            const SizedBox(height: 16),
            Text(
              'All PayDirect JWT API endpoints require JWE/JWS encryption for secure communication. The request payload (including card data) is encrypted with JWE and signed with JWS.',
                style: GoogleFonts.poppins(
                fontSize: 15,
  ...
  Widget _buildPaymentInitiateSection(bool isDark) {
    return _build4StepApiSection(
      ...
      description: 'Create a new payment transaction with JWT authentication and card data. This API immediately captures the payment upon successful authorization.',
      method: 'POST',
  ...
  "message": "Transaction Sent For Capture Successfully",
  "timestamp": "01/12/2025 14:01:54",
  "reasonCode": "GL-202-001",
  "data": {
    "statusUrl": "https://api.uat.payglocal.in/gl/v1/payments/gl_o-9a713b19377b3a33b41aj0vq8/status",
    "merchantTxnId": "TXN_20250122_001",
