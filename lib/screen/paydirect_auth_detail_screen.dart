...
class PayDirectAuthDetailScreen extends StatefulWidget {
  ...
  @override
  State<PayDirectAuthDetailScreen> createState() => _PayDirectAuthDetailScreenState();
}
  ...
  PreferredSizeWidget _buildAppBar(bool isDark, bool isDesktop) {
    return AppBar(
      ...
      actions: [
        ...
        ElevatedButton.icon(
          onPressed: () {
            Navigator.pushNamed(context, AppRouter.paydirectApiReferenceAuth);
          },
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          Text(
            'Try our interactive demo to see how Auth & Capture works in a real e-commerce scenario. Experience the complete flow from authorization to capture and refund.',
            style: GoogleFonts.inter(
              fontSize: 15,
