...
class PayDirectAuthAPIReferenceScreen extends StatefulWidget {
  const PayDirectAuthAPIReferenceScreen({super.key});

  @override
  _PayDirectAuthAPIReferenceScreenState createState() => _PayDirectAuthAPIReferenceScreenState();
}

class _PayDirectAuthAPIReferenceScreenState extends State<PayDirectAuthAPIReferenceScreen> with TickerProviderStateMixin {
  ...
  Widget _buildAuthPaymentSection(bool isDark) {
    return _build4StepApiSection(
      ...
      description: 'Authorize and hold funds using card data without immediate capture. Perfect for hotel bookings, pre-orders, or any scenario where you need to reserve funds before final confirmation.',
      method: 'POST',
