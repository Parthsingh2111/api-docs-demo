...
class PayCollectAPIReferenceScreen extends StatefulWidget {
  const PayCollectAPIReferenceScreen({super.key});

  @override
  _PayCollectAPIReferenceScreenState createState() => _PayCollectAPIReferenceScreenState();
}

class _PayCollectAPIReferenceScreenState extends State<PayCollectAPIReferenceScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: const PremiumAppBar(
        title: 'PayCollect SI - API Reference',
      ),
      body: FadeTransition(
  ...
  Widget _buildHeader(BuildContext context, bool isLargeScreen, bool isDark) {
    return Column(
      ...
      children: [
        Text(
          'PayCollect Standing Instruction API Reference',
